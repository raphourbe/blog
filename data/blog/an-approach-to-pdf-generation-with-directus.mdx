...
![Building warnings](/static/images/understanding-directus-bundles/BuildingWarnings.webp)
...
This is the part of the tutorial where you should adapt to your situation. My function looks like this:

```js:index.js
import puppeteer from "puppeteer";

export default (router, { services }) => {
	const FRONTURL = "something";
	const { ItemsService } = services;
...
In my script, you see this line: `formData.append("folder", directusFolder);`. It is used to upload inside a directus virtual folder, as shown on the picture below. If you do not add this line, the files will be uploaded directly at the root of the File Library.

![Virtual Folder](/static/images/understanding-directus-bundles/VirtualFolder.webp)
...
![Build PDF Flow](/static/images/understanding-directus-bundles/BuildingPDFFlow.webp)
...
![Read Data Flow](/static/images/understanding-directus-bundles/ReadData.webp)
...
export default (router, { services }) => {
  ...
  const apiFileUrl = "http://127.0.0.1:8055/files";
  const directusFolder = "6de02465-cfc2-4ff9-a0bf-a4a9cba85";
  const bearerToken = "Bearer 3zdzdTWpG345somehtingyPndzdzd80";
