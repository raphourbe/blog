---
title: 'Building a SaaS with Directus and Stripe: Part 1'
date: '2022-11-24'
lastmod: '2022-11-24'
...
for handling users, roles and
posts. I used [Stripe Billing](https://stripe.com/docs/billing) to handle the payments,
...
but also to allow them to interact with my API. I show the implementation of this specific point right after [LINK].
...
- `subscriptions` with the informations regarding my subscriptions (price, stripe ID, etc.)
